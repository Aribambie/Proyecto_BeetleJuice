...
def ingest_docs():
    ...
    html_files = get_html_files("BeetleJuice-docs")
    ...
    for doc in documents:
        ...
        if new_url:
            new_url = new_url.replace("BeetleJuice-docs", "https://tim-burton.fandom.com/es/wiki/Beetlejuice")
    ...
    Pinecone.from_documents(documents, embeddings, index_name="beetle")
